...
export const PARTS: PartDefinition[] = [
  ...
  },
  {
    ...
    param1: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["Keps", "Low Profile", "Lock", "Hex"],
    },
    param2: null,
    variants: [
      {
  ...
  },
  {
    ...
    param1: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["Normal", "High Strength", "Low Profile", "Collar Retainer"],
    },
    param2: null,
    variants: [
      {
  ...
  },
  {
    ...
    param1: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["With Adapters", "No Adapters"],
    },
    param2: {
      name: "Size",
      ...
      min: 0.0,
      max: 0.0,
      options: ["3.00in", "1.625in", "4.00in", "2.00in"],
    },
    variants: [
      {
  ...
  },
  {
    ...
    param1: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["High Strength v2", "High Strength", "Normal"],
    },
    param2: {
      name: "Size",
      defaultValue: "12T",
      ...
      min: 0.0,
      max: 0.0,
      options: ["48T", "60T", "36T", "84T", "12T", "72T", "24T"],
    },
    variants: [
      {
  ...
  },
  {
    ...
    param1: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["Nut Retainer", "Bearing Retainer", "Square Retainer"],
    },
    param2: null,
    variants: [
      {
  ...
  },
  {
    ...
    param2: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["2.75in", "4.00in", "3.25in", "2.00in"],
    },
    variants: [
      {
        param1: "V1",
  ...
  },
  {
    ...
    param2: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["Normal", "High Strength", "Low Profile HS"],
    },
    variants: [
      {
        param1: "Clamping",
  ...
  },
  {
    ...
    param1: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["Plastic", "High Strength", "Nylon"],
    },
    param2: {
      name: "Size",
      defaultValue: "1/4in",
      ...
      min: 0.0,
      max: 0.0,
      options: ["4.6mm", "1/4in", "1/16in", "1/2in", "1/8in", "3/8in", "8mm"],
    },
    variants: [
      {
        param1: "Plastic",
  ...
  },
  {
    ...
    param2: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["2.75in", "3.25in", "5.00in", "4.00in"],
    },
    variants: [
      {
        param1: "V2",
  ...
  },
  {
    ...
    param1: {
      ...
      min: 0.0,
      max: 0.0,
      options: ["Without walls", "With walls"],
    },
    param2: null,
    variants: [
      {
