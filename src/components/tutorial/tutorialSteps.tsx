...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    detail:
      'If nothing maps, you’ll see “No supported Protobot catalog parts were found.” (src/App.tsx:253). Success reframes an orthographic camera on the imported bounds and renames the document to the STEP filename. Protobot Rebuilt has no STEP import.',
